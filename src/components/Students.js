                    ...
                    <div className="col-10 col-md-8">
                            <div className=" card accordion  my-5" id="accordionExample">
                                    ...
                                    <div id="collapseThree" className="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
                                        <div className="card-body justify">
                                                    The leaderboard which displays all the activities by registered students would be live at the  <a className="inline" href="https://summerofcodeatuit.github.io/2019/">website</a> Basically it represents the activity of each and every student registered
                                        </div>
                                    </div>
                                    </div>
                                    <div className="card">
