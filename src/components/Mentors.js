                              ...
                              <div id="collapseTwo" className="collapse" aria-labelledby="headingOne" data-parent="#accordionExample">
                                <div className="card-body justify">
                                        <ul className="list-group p-2 list-group-flush ">
                                            ...
                                            <li className="list-group-item">&#9679; Your project should be documented so that others can understand your code.</li>
                                            <li className="list-group-item">&#9679; Your projects should have two or more easy-to-fix or good-first and at least one moderate level issues. </li>
                                        </ul>
                                </div>
                              </div>
                            </div>
